...
$special_pages = array(
    ...
    'anunciate' => array(
        'Anúnciate', // nombre de la pagina
        '' // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'envia-tu-proyecto' => array(
        'Envía tu proyecto', // nombre de la pagina
        '' // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'terminos-de-uso' => array(
        'Términos de uso', // nombre de la pagina
        '' // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
);
