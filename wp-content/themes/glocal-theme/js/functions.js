...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _constants.$)(document).ready(function () {
	    ...
	    var headerLeaderboardAd = (0, _constants.$)('#div-gpt-ad-1531495425185-0');
	    if (headerLeaderboardAd.length && headerLeaderboardAd.height()) {
	        var header = (0, _constants.$)('#header');
	        header.css({
	            'top': '200px'
	        });
                var headerLeaderboard = (0, _constants.$)('#header-leaderboard');
